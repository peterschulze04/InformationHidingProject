"""Base learner wrapper for the FLD ensemble.

A :class:`BaseLearner` pairs a :class:`~.fld.FisherLinearDiscriminantLearner`
with its random feature subspace, handling the fast fancy-indexing projection
that maps the full-dimensional cover/stego matrices down to the learner's
